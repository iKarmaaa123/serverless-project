...
output "lambda_function_dynamodb_name" {
    value = aws_lambda_function.lambda_dynamodb.function_name
    description = "Name for lambda function dynamodb"
}

output "lambda_function_s3_name" {
    value = aws_lambda_function.lambda_s3.function_name
    description = "Name for lambda function s3"
}
